...
describe('HttpModulosRepository', () => {
  ...
  beforeEach(() => { TestBed.configureTestingModule({ providers: [HttpModulosRepository, provideHttpClient(), provideHttpClientTesting()] }); repository = TestBed.inject(HttpModulosRepository); http = TestBed.inject(HttpTestingController); });
