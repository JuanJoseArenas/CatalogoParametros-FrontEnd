...
describe('OrganizacionesComponent', () => {
  ...
  it('edita y reporta errores al guardar', () => {
    ...
    expect(component.organizacionForm.value.fechaInicio).toBe('2026-01-01T00:00:00');
  ...
  it('conserva el instante y la precisi?n al editar solo el nombre desde otra zona', () => {
    ...
    component.editOrganizacion({ id: '1', nombre: 'Original', fechaInicio, fechaFinal });
    expect(component.organizacionForm.value.fechaInicio).toBe(fechaParaFormulario(fechaInicio));
    component.organizacionForm.patchValue({ nombre: 'Nuevo' });
    component.saveOrganizacion();
  ...
  it('env?a la hora elegida con desfase local y rechaza fechas inv?lidas', () => {
    ...
    component.organizacionForm.patchValue({ nombre: 'Nueva', fechaInicio: '2026-07-15T14:35:42', fechaFinal: '2026-12-31T18:20:00' });
    component.saveOrganizacion();
    ...
    component.organizacionForm.patchValue({ nombre: 'Nueva', fechaInicio: '2026-02-30T14:00:00', fechaFinal: '2026-12-31T18:20:00' });
    component.saveOrganizacion();
